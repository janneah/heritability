...
data <- readRDS(paste0("steps/pheno/", pairs, "_", birth_cohort, "_phecode_status_min400", file, ".rds"))
...
saveRDS(res, paste0("results/", pairs, "_", birth_cohort, "_h2_min400", file, "_", iterations, "iter.rds"))
